...
main() {
  ...
  ssh -o BatchMode=yes "${SSH_HOST}" \
    "chmod +x '${REMOTE_SCRIPT}' && \
     ...
     ALIYUN_ZONE='${ALIYUN_ZONE}' \
     OSS_REGION='${OSS_REGION}' \
     OSS_ENDPOINT='${OSS_ENDPOINT}' \
     OSS_BUCKET='${OSS_BUCKET}' \
     OSS_MODEL_URI='${OSS_MODEL_URI}' \
     ACR_INSTANCE_ID='${ACR_INSTANCE_ID}' \
     ACR_REGION='${ACR_REGION}' \
     ...
     COORDINATOR_HOST_PORT='${COORDINATOR_HOST_PORT}' \
     PUBLISH_COORDINATOR_PORT='${PUBLISH_COORDINATOR_PORT}' \
     WORKER_COORDINATOR_URL='${WORKER_COORDINATOR_URL}' \
     GATEWAY_COORDINATOR_URL='${GATEWAY_COORDINATOR_URL}' \
     GATEWAY_INTERNAL_OUTPUT_URL='${GATEWAY_INTERNAL_OUTPUT_URL}' \
     PUBLISH_WORKER_PORTS='${PUBLISH_WORKER_PORTS}' \
     WORKER_ADVERTISE_HOST='${WORKER_ADVERTISE_HOST}' \
     WORKER_ID_PREFIX='${WORKER_ID_PREFIX}' \
     START_VAE_WORKER='${START_VAE_WORKER}' \
     VAE_HOST_PORT='${VAE_HOST_PORT}' \
     DENOISER_GPU_INDICES='${DENOISER_GPU_INDICES}' \
     DENOISER_HOST_PORT_BASE='${DENOISER_HOST_PORT_BASE}' \
     DENOISER_MAX_SLOTS='${DENOISER_MAX_SLOTS}' \
     USE_DEDICATED_DATA_DISK='${USE_DEDICATED_DATA_DISK}' \
