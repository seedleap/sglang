...
DENOISER_BASE_REPLICAS="${DENOISER_BASE_REPLICAS:-4}"
VAE_BASE_REPLICAS="${VAE_BASE_REPLICAS:-1}"
DENOISER_PEAK_REPLICAS="${DENOISER_PEAK_REPLICAS:-4}"
VAE_PEAK_REPLICAS="${VAE_PEAK_REPLICAS:-1}"
LINGBOT_DENOISER_REPLICAS="${LINGBOT_DENOISER_REPLICAS:-2}"
...
sed -i.bak \
  ...
  -e "s|REPLACE_WITH_LINGBOT_DENOISER_REPLICAS|${LINGBOT_DENOISER_REPLICAS}|g" \
