...
The S1/S3/S4 stacked-binary integration, strict correctness contract,
position-balanced ABBA matrix, exact-window Nsight attribution, interaction
residual, rollback plan, and combined review quiz are tracked in
[`MINWM_FUSED_OPS_INTEGRATION.zh-CN.md`](MINWM_FUSED_OPS_INTEGRATION.zh-CN.md).
