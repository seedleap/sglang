    ...
    try:
        ...
        while session.can_schedule_chunk():
            ...
            await coordinator.submit(
                lambda chunk=chunk, batch=batch, handle=handle, send_stats=send_stats, request_prepare_ms=request_prepare_ms, scheduler_forward_ms=scheduler_forward_ms, chunk_started=chunk_started, vae_started=vae_started: (
