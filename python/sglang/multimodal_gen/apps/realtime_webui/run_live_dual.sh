...
if [[ -z "${REALTIME_UI_CONFIG_JSON:-}" ]]; then
  export REALTIME_UI_CONFIG_JSON='{"generationModes":["i2v"],"defaultGenerationMode":"i2v","singleExperience":false,"dualModels":{"minwm":{"label":"Zing"},"lingbot2":{"label":"LingBot2","targetFps":16,"sinkSize":9,"windowFrames":18}}}'
fi
