...
assert.match(html, /world_rules_controller\.js\?v=world-rules-v2/);
assert.match(html, /h264_websocket_session\.js\?v=lingbot-startup-v2/);
assert.match(html, /styles\.css\?v=world-studio-h264-rules-v2/);
assert.match(html, /app\.js\?v=world-studio-h264-rules-v3/);
